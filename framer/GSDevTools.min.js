...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine("GSDevTools", ["TweenLite", "core.Animation", "core.SimpleTimeline", "TimelineLite", "utils.Draggable", "plugins.CSSPlugin"], function(e, t, o, n, i) {
        var r, s, a, l, c, d = document,
            ...
            u = 0,
            h = {}, m = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
            ...
            Y = function() {
                ...
                if (this.vars = o = o || {}, o.id = o.id || ("string" == typeof o.animation ? o.animation : u++), h[o.id + ""] = this, !x) // REMOVE THIS TO FUNCTION---return window.location.href = "http://" + m + v + "?plugin=GSDevTools&source=codepen", !1;
                    ...
                    ye = function() {
                        ...
                        if ("string" == typeof n && (n = _(n)), n instanceof t || console.log("GSDevTools error: invalid animation."), n !== g) {
                            if (g && (g._inProgress = te, g._outProgress = oe), g = n, b && (c = b.timeScale(), b.target === k && (k.resume(), b.kill())), te = g._inProgress || 0, oe = g._outProgress || 100, K.style.left = te + "%", J.style.left = oe + "%", X && (F("animation", g.vars.id), F("in", te), F("out", oe)), r = 0, l = Math.min(1e3, o.maxDuration || 1e3, S(g)), g === N || !1 !== o.globalSync) {
                                if (Y(), b = E, a && a !== O && console.log("Error: GSDevTools can only have one instance that's globally synchronized."), a = O, g !== N)
                                    for ((s = (i = g).totalDuration()) > 99999999 && (s = i.duration()); i.timeline.timeline;) r = r / i._timeScale + i._startTime, s = s / i._timeScale + i._startTime, i = i.timeline;
                                else s = N.duration();
...
function(e) {
    ...
    _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(e, t, o) {
        var n, i, r, s, a, l, c, d, p, f = {
            ...
            }, w = y.documentElement || {}, b = function(e) {
            ...
            ge = te(T, "transformOrigin").replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
            ue = te(T, "transform"),
            he = ue.replace(/^ms/g, "Ms").replace(/([A-Z])/g, "-$1").toLowerCase(),
            me = {}, ve = {}, xe = _gsScope.SVGElement,
            ye = function(e) {
            ...
            Se = function(e) {
                ...
                if (!1 !== Ge.cacheSVGData && e._dCache && e._dCache.lastUpdate === t.ticker.frame) return e._dCache;
                var o, n = e._dCache = e._dCache || {}, i = ne(e),
                    r = e.getBBox && ye(e),
